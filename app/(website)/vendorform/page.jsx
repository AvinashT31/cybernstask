    ...
    return (
        <>
            ...
            <div className="flex flex-wrap gap-3">
                {sizes.map((size) => (
                    <Button key={size} color="default" className="bg-blue-700 hover:bg-blue-800 text-white" onPress={() => handleOpen(size)}>Add New Vendor</Button>
                ))}
            </div>
            <Modal
                size={size}
            ...
            >
                <ModalContent>
                    {(onClose) => (
                        <>
                            <ModalHeader className="flex flex-col gap-1">Add Vendor</ModalHeader>
                            <ModalBody>
                                <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10'>
                                    ...
                                    <div className='flex flex-col'>
                                        <label className="text-gray-700">vendortype:</label>
                                        <input
                                            type="text"
                                            // name="title"
                                            // value={blogdata.title}
                                    ...
                                    <div className='flex flex-col'>
                                        <label className="text-gray-700">serviceProvided:</label>
                                        <input
                                            type="text"
                                            // name="title"
                                            // value={blogdata.title}
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <Autocomplete
                                            className="text-black mt-2 text-sm font-light"
                                            variant="bordered"
                                            radius="md"
                                            color="primary"
                                        ...
                                        >
                                            {animals.map((animals) => (
                                                <AutocompleteItem key={animals.value} value={animals.value}>
                                                    {animals.label}
                                                </AutocompleteItem>
                                            ))}
                                        </Autocomplete>
                            ...
                            <ModalFooter>
                                <Button color="default" className="bg-blue-700 hover:bg-blue-800 text-white" onPress={onClose}>
                                    Close
                                </Button>
                                <Button color="default" className="bg-blue-700 hover:bg-blue-800 text-white" onPress={onClose}>
                                    Submit
